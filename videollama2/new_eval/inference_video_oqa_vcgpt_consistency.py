...
def run_inference(args):
    ...
    for i, (video_tensors, video_names, questions1, questions2, answers) in enumerate(tqdm(dataloader)):
        ...
        output1 = x_infer(video_tensor, question1, mode='vanilla', model=model, tokenizer=tokenizer, do_sample=True)
        output1 = x_infer(video_tensor, question2, mode='vanilla', model=model, tokenizer=tokenizer, do_sample=True)
