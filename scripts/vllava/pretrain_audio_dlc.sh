...
export WANDB_PROJECT=videollama2_vllava_audio_stage1
RUN_NAME=videollama2_vllava_audio_stage1
DATA_DIR=datasets
OUTP_DIR=work_dirs
torchrun --nnodes $WORLD_SIZE \
    ...
    --tf32 True \
    --fp16 False \
    --output_dir /mnt/data/xyf/va2/output/stage1_mlp_videollm_mistral_beats_1024_updated \
    --num_train_epochs 1 \
