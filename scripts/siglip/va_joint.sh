...
torchrun --nnodes $WORLD_SIZE \
    ...
    --data_path /mnt/data/xyf/stage3_valor.json \
    --vision_tower /mnt/data/xyf/tmpfs_models/siglip-so400m-patch14-384 \
    --audio_tower /mnt/data/xyf/va2/output/vlb_audio_stage2_mlp_encoder_beats_mistral_videollm_ep2_update/audio_tower.bin \
